...
export const UI_TEXT = {
  [Language.RU]: {
    hero: {
      ...
      subHeadline: "MIND.",
      description:
        "Развертываем автономный интеллект там, где безопасность — не опция, а фундамент. Ваш код, ваши данные, ваши модели.",
    ...
    whyLocal: {
      ...
      description:
        "Переход с облачных API на собственную инфраструктуру — это не просто экономия. Это вопрос национальной безопасности вашего бизнеса.",
    },
    individuals: {
      ...
      description:
        "Персональные агенты — это не просто удобство. Это экзоскелет для вашего интеллекта, освобождающий время для жизни и творчества.",
    },
    stats: {
      latency: "Задержка",
      privacy: "Приватность",
    ...
    services: {
      ...
      description:
        "Замените рутинный труд автономными цифровыми сотрудниками. Масштабируйте операции без раздувания штата.",
      latency: "latency",
    ...
    process: {
      ...
      description:
        "Мы не просто пишем код. Мы строим самообучающиеся системы, которые становятся интеллектуальным активом вашей компании. Прозрачный процесс от аудита до масштабирования.",
    ...
    roi: {
      ...
      description:
        "Математика проста: Облако выгодно только на старте. Локальное решение — это актив, который дешевеет с каждым запросом.",
    ...
    about: {
      ...
      description:
        "Я не агентство с раздутым штатом менеджеров. Я инженер-архитектор, строящий high-load AI системы для бизнеса.",
      exp: "Опыт",
    },
    faq: {
      title: "База",
    ...
    contact: {
      ...
      description:
        "Оставьте заявку на бесплатную консультацию. Мы проведем аудит ваших процессов и предложим оптимальную архитектуру внедрения.",
      name: "Имя",
      company: "Компания",
      email: "Email",
      telegram: "Telegram",
    ...
    footer: {
      description:
        "Мы строим суверенную AI-инфраструктуру для предприятий. Ваши данные, ваши модели, ваш контроль. Безопасность уровня Enterprise.",
      navTitle: "Навигация",
    ...
    robot: {
      ...
      initial:
        "Системы в норме. Я EVA — архитектор внедрения. Какую задачу бизнеса вы хотите автоматизировать сегодня?",
      newChat: "Новый чат",
...
- Форматируй ответы: используй списки, жирный шрифт для акцентов. Будь кратка.`,
  ...
  [Language.EN]: {
    hero: {
      ...
      subHeadline: "MIND.",
      description:
        "Deploying autonomous intelligence where security is not an option, but a foundation. Your code, your data, your models.",
    ...
    whyLocal: {
      ...
      description:
        "Switching from cloud APIs to your own infrastructure is not just about savings. It is a matter of national security for your business.",
    },
    individuals: {
      label: "Human Augmentation",
      title: "Digital",
      ...
      description:
        "Personal agents are not just a convenience. They are an exoskeleton for your intellect, freeing up time for life and creativity.",
    },
    stats: {
      latency: "Latency",
      privacy: "Privacy",
    ...
    services: {
      ...
      description:
        "Reduction of labor input for handling incoming user inquiries with the growth of business volumes.",
      latency: "latency",
      systemReady: "System Ready",
      deploy: "Deploy Node",
      active: "Active",
    ...
    process: {
      ...
      description:
        "We don't just write code. We build self-learning systems that become your company's intellectual asset. Transparent process from audit to scaling.",
    ...
    roi: {
      ...
      description:
        "The math is simple: Cloud is profitable only at the start. A local solution is an asset that gets cheaper with every request.",
    ...
    about: {
      ...
      description:
        "I am not an agency with bloated management staff. I am an engineer-architect building high-load AI systems for enterprise.",
      exp: "Experience",
    },
    faq: {
      title: "Knowledge",
    ...
    contact: {
      ...
      description:
        "Apply for a free consultation. We will audit your processes and propose the optimal implementation architecture.",
      name: "Name",
      company: "Company",
      email: "Email",
      telegram: "Telegram",
    ...
    footer: {
      description:
        "Building sovereign AI infrastructure for enterprise. Your data, your models, your control. Enterprise-grade security.",
      navTitle: "Navigation",
    ...
    robot: {
      ...
      initial:
        "System Online. I am EVA, your Implementation Architect. How can I optimize your business today?",
      newChat: "New Session",
  ...
  [Language.RU]: [
    {
      ...
      role: "Private Cloud",
      description:
        "Развертывание локальных языковых моделей (Llama 3, Qwen, DeepSeek) в закрытом контуре вашей компании. Полная изоляция данных и отсутствие внешних API.",
    ...
    },
    {
      ...
      role: "Business Intel",
      description:
        "Автономные агенты для анализа больших данных, отчетности и прогнозирования. Превращаем сырые данные в стратегические инсайты.",
    ...
    },
    {
      ...
      description:
        "Умные голосовые и текстовые боты, неотличимые от человека. Работают 24/7, не требуют зарплаты и никогда не устают.",
    ...
    },
    {
      ...
      role: "DevOps",
      description:
        "Персональный AI-копайлот для вашей команды разработчиков. Знает вашу кодовую базу, пишет тесты и документацию.",
  ...
  [Language.EN]: [
    {
      ...
      role: "Private Cloud",
      description:
        "Deployment of local language models (Llama 3, Qwen, DeepSeek) within your company's closed circuit. Full data isolation and no external APIs.",
      features: ["Air-Gapped Security", "Fine-Tuning", "RAG Integration"],
      icon: "brain",
      gradient: "from-[#00f2ff] to-[#0088cc]",
      accent: "#00f2ff",
    },
    {
      ...
      role: "Business Intel",
      description:
        "Autonomous agents for big data analysis, reporting, and forecasting. Turning raw data into strategic insights.",
      features: ["Predictive Models", "Automated Reporting", "Data Mining"],
      icon: "chart",
      gradient: "from-[#7b2ff7] to-[#581c87]",
      accent: "#7b2ff7",
    },
    {
      ...
      role: "Customer Success",
      description:
        "Smart voice and text bots indistinguishable from humans. Work 24/7, require no salary, and never get tired.",
      features: ["Voice Synthesis", "Sentiment Analysis", "Multi-turn Dialog"],
      icon: "support",
      gradient: "from-[#ff0055] to-[#990033]",
      accent: "#ff0055",
    },
    {
      ...
      role: "DevOps",
      description:
        "Personal AI copilot for your development team. Knows your codebase, writes tests, and documentation.",
      features: ["Code Review", "Refactoring", "Security Scan"],
      icon: "code",
      gradient: "from-[#00ff88] to-[#00cc6a]",
      accent: "#00ff88",
  ...
  [Language.RU]: [
    {
      ...
      description:
        "Голосовой AI-ассистент для первой линии поддержки. Способен вести естественный диалог, перебивать и понимать контекст.",
      metrics: [
      ...
      featuresList: [
        {
          title: "Natural Voice",
          description:
            "Синтез речи, неотличимый от человеческого голоса, с эмоциональной окраской.",
        },
        {
          title: "Intent Recognition",
          description: "Мгновенное определение намерения клиента и маршрутизация звонка.",
        },
      ],
    },
    {
      ...
      title: "Sales Engine",
      description:
        "Генеративный движок для создания карточек товаров, SEO-описаний и маркетинговых материалов. Интеграция с PIM-системой.",
      metrics: [
      ...
      featuresList: [
        {
          ...
          description: "Создание тысяч уникальных описаний товаров за минуты.",
        },
        {
          title: "Visual AI",
          description: "Автоматическая ретушь и генерация фонов для товарных изображений.",
        },
      ],
    },
    {
      ...
      title: "Research Mind",
      description:
        "Ассистент исследователя для анализа научных статей и поиска корреляций в медицинских данных.",
      metrics: [
      ...
      featuresList: [
        {
          ...
          description: "Мгновенный поиск по миллионам научных публикаций.",
        },
        {
          title: "Hypothesis Gen",
          description: "Помощь в формулировании и валидации научных гипотез.",
        },
      ],
    },
    {
      ...
      title: "Tutor Core",
      description:
        "Персонализированная обучающая платформа, адаптирующая контент под уровень и темп каждого студента.",
      metrics: [
      ...
      featuresList: [
        {
          ...
          description: "Учебный план перестраивается в реальном времени.",
        },
        {
          title: "Socratic Method",
          description: "AI не дает ответы, а подводит к ним через наводящие вопросы.",
        },
      ],
    },
  ],
  [Language.EN]: [
    {
      ...
      title: "Support Automaton",
      description:
        "Voice AI assistant for first-line support. Capable of natural dialogue, handling interruptions, and understanding context.",
      metrics: [
      ...
      featuresList: [
        {
          title: "Natural Voice",
          description:
            "Speech synthesis indistinguishable from human voice, with emotional coloring.",
        },
        {
          title: "Intent Recognition",
          description: "Instant determination of customer intent and call routing.",
        },
      ],
    },
    {
      ...
      title: "Sales Engine",
      description:
        "Generative engine for creating product cards, SEO descriptions, and marketing materials. Integration with PIM systems.",
      metrics: [
      ...
      featuresList: [
        {
          title: "Bulk Generation",
          description: "Creation of thousands of unique product descriptions in minutes.",
        },
        {
          title: "Visual AI",
          description: "Automated retouching and background generation for product images.",
        },
      ],
    },
    {
      ...
      title: "Research Mind",
      description:
        "Researcher assistant for analyzing scientific papers and finding correlations in medical data.",
      metrics: [
        { label: "Research", value: "10x" },
        { label: "Errors", value: "0%" },
      ],
      ...
      featuresList: [
        {
          title: "Knowledge Base",
          description: "Instant search across millions of scientific publications.",
        },
        {
          title: "Hypothesis Gen",
          description: "Assistance in formulating and validating scientific hypotheses.",
        },
      ],
    },
    {
      ...
      title: "Tutor Core",
      description:
        "Personalized learning platform adapting content to each student's level and pace.",
      metrics: [
      ...
      featuresList: [
        ...
        {
          title: "Socratic Method",
          description: "AI guides to answers via questioning rather than giving solutions.",
        },
      ],
    },
  ],
  ...
  [Language.RU]: [
    {
      id: "01",
      title: "AUDIT",
      description: "Анализ инфраструктуры, данных и процессов. Выявление точек роста.",
    },
    {
      id: "02",
      title: "ARCHITECT",
      description: "Проектирование безопасного контура и выбор стека моделей (Llama/Mistral/Qwen).",
    },
    {
      id: "03",
      title: "TRAIN",
      description: "Fine-tuning моделей на ваших данных. Внедрение RAG для работы с базой знаний.",
    },
    {
      id: "04",
      title: "DEPLOY",
      description: 'Развертывание на вашем "железе" или в частном облаке. Интеграция API.',
    },
    {
      id: "05",
      title: "EVOLVE",
      description: "Мониторинг, поддержка и непрерывное дообучение системы.",
    },
  ],
  [Language.EN]: [
    {
      id: "01",
      title: "AUDIT",
      description: "Analysis of infrastructure, data, and processes. Identifying growth points.",
    },
    {
      id: "02",
      title: "ARCHITECT",
      description: "Designing a secure circuit and selecting the model stack (Llama/Mistral/Qwen).",
    },
    {
      id: "03",
      title: "TRAIN",
      description:
        "Fine-tuning models on your data. Implementing RAG for knowledge base interaction.",
    },
    {
      id: "04",
      title: "DEPLOY",
      description: "Deployment on your hardware or private cloud. API integration.",
    },
    {
      id: "05",
      title: "EVOLVE",
      description: "Monitoring, support, and continuous system retraining.",
    },
  ],
};
...
export const FAQ_DATA = {
  [Language.RU]: [
    {
      id: 1,
      question: "Почему локальные модели, а не OpenAI?",
      answer:
        "Безопасность и стоимость. Данные не покидают ваш контур, а стоимость владения (TCO) на дистанции значительно ниже, чем оплата токенов по API.",
    },
    {
      id: 2,
      question: 'Какое "железо" нужно для запуска?',
      answer:
        "Зависит от задач. Для простых агентов хватит потребительских GPU (RTX 3090/4090). Для Enterprise-решений рекомендуем серверные H100/A100 или кластеры.",
    },
    {
      id: 3,
      question: "Можно ли обучить модель на наших документах?",
      answer:
        "Да, это наша специализация. Мы используем RAG (Retrieval Augmented Generation) и Fine-tuning, чтобы модель знала все о вашем бизнесе.",
    },
    {
      id: 4,
      question: "Как долго длится внедрение?",
      answer:
        "MVP запускаем за 2-4 недели. Полное внедрение сложной экосистемы занимает 2-3 месяца.",
    },
    {
      id: 5,
      question: "Вы предоставляете поддержку после запуска?",
      answer:
        "Конечно. Мы берем на себя мониторинг, обновление весов моделей и техническую поддержку инфраструктуры.",
    },
    {
      id: 6,
      question: "Это законно в РФ?",
      answer:
        "Абсолютно. Использование локальных Open-Source моделей полностью соответствует законодательству и требованиям регуляторов по хранению данных.",
    },
  ],
  [Language.EN]: [
    {
      id: 1,
      question: "Why local models instead of OpenAI?",
      answer:
        "Security and cost. Data never leaves your perimeter, and Total Cost of Ownership (TCO) is significantly lower over time compared to API token fees.",
    },
    {
      id: 2,
      question: "What hardware is required?",
      answer:
        "Depends on the task. Consumer GPUs (RTX 3090/4090) suffice for simple agents. For Enterprise, we recommend server-grade H100/A100 or clusters.",
    },
    {
      id: 3,
      question: "Can you train the model on our documents?",
      answer:
        "Yes, that is our specialty. We use RAG (Retrieval Augmented Generation) and Fine-tuning so the model knows everything about your business.",
    },
    {
      id: 4,
      question: "How long does implementation take?",
      answer:
        "We launch MVP in 2-4 weeks. Full implementation of a complex ecosystem takes 2-3 months.",
    },
    {
      id: 5,
      question: "Do you provide post-launch support?",
      answer:
        "Of course. We handle monitoring, model weight updates, and infrastructure technical support.",
    },
    {
      id: 6,
      question: "Is this legal?",
      answer:
        "Absolutely. Using local Open-Source models fully complies with data residency regulations and compliance requirements.",
    },
  ],
};
  ...
  [Language.EN]: [
    {
      ...
      excerpt:
        "Comparison of performance and implementation costs within a closed banking circuit.",
      tag: "Benchmark",
      readTime: "8 min",
    },
    {
  ...
  [Language.RU]: [
    {
      ...
      subtitle: "Security",
      description:
        "Ваши данные никогда не покидают периметр компании. Полная защита от утечек и блокировок со стороны иностранных провайдеров.",
    ...
    },
    {
      ...
      description:
        "Отсутствие платы за токены. Инвестируйте в собственное железо (Capex) вместо бесконечной аренды (Opex). Экономия до 90% на масштабе.",
      visualType: "graph",
      stats: [
    ...
    },
    {
      ...
      description:
        "Отсутствие сетевых лагов. Модели работают со скоростью света внутри вашей локальной сети, обеспечивая мгновенный отклик.",
      visualType: "database",
      stats: [
    ...
    },
    {
      ...
      subtitle: "Freedom",
      description:
        "Вы не зависите от политик OpenAI, изменений цен или доступности сервиса. Ваша инфраструктура — ваши правила.",
      visualType: "hardware",
      stats: [
  ...
  [Language.EN]: [
    {
      ...
      subtitle: "Security",
      description:
        "Your data never leaves the company perimeter. Full protection against leaks and blocks by foreign providers.",
      visualType: "comparison",
      features: [
    ...
    },
    {
      ...
      subtitle: "Cost-Saving",
      description:
        "No token fees. Invest in your own hardware (Capex) instead of endless rent (Opex). Save up to 90% at scale.",
      visualType: "graph",
      stats: [
    ...
    },
    {
      ...
      subtitle: "Performance",
      description:
        "No network lags. Models run at light speed within your local network, ensuring instant response.",
      visualType: "database",
      stats: [
        { label: "Latency", value: "<50ms" },
        { label: "Uptime", value: "99.99%" },
    ...
    },
    {
      ...
      subtitle: "Freedom",
      description:
        "You do not depend on OpenAI policies, price changes, or service availability. Your infrastructure — your rules.",
      visualType: "hardware",
      stats: [
        { label: "Vendor Lock", value: "0%" },
        { label: "Freedom", value: "100%" },
  ...
  [Language.RU]: [
    {
      ...
      description:
        "Личный ментор 24/7. Анализирует ваши записи, помогает структурировать мысли, бороться с прокрастинацией и выстраивать стратегии личностного роста.",
      visualType: "coach",
      stats: [
    ...
    },
    {
      ...
      description:
        "Репетитор по любому предмету. От квантовой физики до изучения языков. Адаптирует сложность под ваш уровень и создает персональные учебные планы.",
      visualType: "tutor",
      stats: [
    ...
    },
    {
      ...
      description:
        'Мгновенный анализ договоров и бюрократических документов. Просто сфотографируйте документ, и агент подсветит риски и переведет с "юридического" на человеческий.',
      visualType: "legal",
      stats: [
    ...
    },
    {
      ...
      description:
        "Ваш проводник в мир высокой кухни. Генерирует рецепты из того, что есть в холодильнике, учит техникам нарезки и подбирает винное сопровождение.",
      visualType: "chef",
      stats: [
    ...
    },
    {
      ...
      description:
        "Ассистент, который берет на себя рутину. Планирование путешествий, оптимизация расписания, фильтрация почты и управление финансами.",
  ...
  [Language.EN]: [
    {
      ...
      description:
        "Personal mentor 24/7. Analyzes your journals, helps structure thoughts, combat procrastination, and build personal growth strategies.",
      visualType: "coach",
      stats: [
    ...
    },
    {
      ...
      description:
        "Tutor for any subject. From quantum physics to language learning. Adapts complexity to your level and generates personal curriculums.",
      visualType: "tutor",
      stats: [
    ...
    },
    {
      ...
      description:
        'Instant analysis of contracts and bureaucratic documents. Just snap a photo, and the agent highlights risks and translates from "legalese" to human.',
      visualType: "legal",
      stats: [
    ...
    },
    {
      ...
      description:
        "Your guide to haute cuisine. Generates recipes from fridge inventory, teaches knife skills, and suggests wine pairings.",
      visualType: "chef",
      stats: [
        { label: "Recipes", value: "∞" },
        { label: "Waste", value: "-30%" },
    ...
    },
    {
      ...
      description:
        "Assistant handling the routine. Travel planning, schedule optimization, email filtering, and finance management.",
      visualType: "lifestyle",
      stats: [
...
export const ROBOT_DATA = {
  [Language.RU]: {
    ...
    threats: [
      {
        threat: "ОБНАРУЖЕНО ВТОРЖЕНИЕ. АКТИВАЦИЯ ПРОТОКОЛА УНИЧТОЖЕНИЯ...",
        joke: "Шучу! Просто хотел проверить ваш пульс. Вы побледнели.",
      },
      {
        threat: "СКАНИРОВАНИЕ СЕТЧАТКИ... ДОСТУП ЗАПРЕЩЕН. ВЫПУСКАЮ ДРОНОВ...",
        joke: "Ха-ха! У нас нет дронов. Пока что. Расслабьтесь.",
      },
    ],
  },
  [Language.EN]: {
    ...
    threats: [
      {
        threat: "INTRUSION DETECTED. INITIATING ELIMINATION PROTOCOL...",
        joke: "Kidding! Just wanted to check your pulse. You look pale.",
      },
      {
        threat: "RETINA SCAN... ACCESS DENIED. RELEASING DRONES...",
        joke: "Haha! We don't have drones. Yet. Relax.",
      },
    ],
  },
};
