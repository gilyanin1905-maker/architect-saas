...
const Navbar: React.FC<NavbarProps> = ({ lang, onLangChange }) => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-[100] transition-all duration-700 ${isScrolled ? "py-4" : "py-8"}`}
    >
      <div className="container mx-auto px-6">
        <div
          className={`flex justify-between items-center px-8 rounded-full transition-all duration-700 ${isScrolled ? "glass py-3 shadow-2xl border-white/10" : "bg-transparent py-0"}`}
        >
          <a
            href="#hero"
