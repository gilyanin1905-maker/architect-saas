          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white [.light_&]:bg-black rounded-xl flex items-center justify-center shadow-lg">
                <span className="font-display font-black text-black [.light_&]:text-white text-xl">
                  A
                </span>
              </div>
              <span className="font-display font-bold text-lg tracking-widest uppercase">
                Architect<span className="text-[#00f2ff]">SaaS</span>
              </span>
            </div>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a
                ...
                className="w-12 h-12 glass rounded-2xl flex items-center justify-center text-white/50 hover:text-[#00f2ff] hover:bg-white/5 border border-white/5 hover:border-[#00f2ff]/30 transition-all hover:scale-110 shadow-lg"
                aria-label="Telegram"
              >
              ...
              <a
                href="#"
                className="w-12 h-12 glass rounded-2xl flex items-center justify-center text-white/50 hover:text-[#7b2ff7] hover:bg-white/5 border border-white/5 hover:border-[#7b2ff7]/30 transition-all hover:scale-110 shadow-lg"
                aria-label="GitHub"
              >
              ...
              <a
                href="#"
                className="w-12 h-12 glass rounded-2xl flex items-center justify-center text-white/50 hover:text-white hover:bg-white/5 border border-white/5 hover:border-white/30 transition-all hover:scale-110 shadow-lg"
                aria-label="LinkedIn"
              >
            ...
            <div className="space-y-4">
              <div className="glass p-4 rounded-xl border-white/5 [.light_&]:border-black/5 group hover:border-[#7b2ff7]/30 transition-all">
                ...
                <a
                  ...
                  className="text-sm font-mono text-white/80 group-hover:text-white transition-colors"
                >
