...
const FAQ: React.FC<FAQProps> = ({ lang }) => {
  ...
  // Handle ESC key press & focus management
  useEffect(() => {
  ...
  const handleOpen = (id: number, e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {faqItems.map((item, index) => (
            <motion.button
              ...
              onClick={(e: React.MouseEvent<HTMLButtonElement>) => handleOpen(item.id, e)}
