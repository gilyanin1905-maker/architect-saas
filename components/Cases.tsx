...
const BankingVisual = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    <svg
      viewBox="0 0 400 400"
      className="w-[120%] h-[120%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-80 mix-blend-screen [.light_&]:mix-blend-multiply pointer-events-none"
    >
      <defs>
...
const EcomVisual = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    ...
    >
      {/* Grid Background */}
      <path
        d="M50 350 H350 M50 300 H350 M50 250 H350 M50 200 H350 M50 150 H350"
        stroke="currentColor"
        strokeWidth="1"
        strokeOpacity="0.1"
      />
      <path
        d="M50 350 V100 M100 350 V100 M150 350 V100 M200 350 V100 M250 350 V100 M300 350 V100 M350 350 V100"
        stroke="currentColor"
        strokeWidth="1"
        strokeOpacity="0.1"
      />
      ...
      >
        ...
        <circle
          ...
          strokeOpacity="0.5"
        />
        <text x="340" y="80" fill="var(--accent-cyan)" fontSize="14" fontWeight="bold">
          +400%
        </text>
      </motion.g>
    </svg>
...
const PharmaVisual = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    <svg
      viewBox="0 0 400 400"
      className="w-[120%] h-[120%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-60 mix-blend-screen [.light_&]:mix-blend-multiply pointer-events-none"
    >
...
const CaseVisual = ({ industry }: { industry: string }) => {
  switch (industry) {
    ...
    case "Telecom":
      return <TelecomVisual />;
    case "E-com":
      return <EcomVisual />;
    case "Gamedev":
      return <GamedevVisual />;
    case "Pharma":
      return <PharmaVisual />;
    case "Education":
...
const Cases: React.FC<CasesProps> = ({ lang }) => {
  ...
  return (
    <section
      id="cases"
      className="py-8 md:py-32 w-full relative overflow-hidden flex flex-col justify-center"
    >
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <button
            onClick={handlePrev}
            className="hidden lg:flex absolute top-1/2 -left-16 -translate-y-1/2 w-12 h-12 rounded-full border border-white/10 [.light_&]:border-black/10 items-center justify-center text-white/40 hover:text-white hover:bg-white/5 transition-colors z-20"
          >
            <svg
              width="24"
              height="24"
          ...
          <button
            onClick={handleNext}
            className="hidden lg:flex absolute top-1/2 -right-16 -translate-y-1/2 w-12 h-12 rounded-full border border-white/10 [.light_&]:border-black/10 items-center justify-center text-white/40 hover:text-white hover:bg-white/5 transition-colors z-20"
          >
            <svg
              width="24"
              height="24"
            ...
            >
              ...
              <div className="lg:col-span-8 relative rounded-[32px] md:rounded-[40px] overflow-hidden border border-white/10 [.light_&]:border-black/5 bg-[#050816] [.light_&]:bg-white group min-h-[300px] md:min-h-0 flex flex-col">
                ...
                <div className="relative z-20 h-full p-6 md:p-12 flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="text-sm md:text-2xl font-display font-bold text-white/30 mb-1">
                        Architect AI
                      </div>
                      <h3 className="text-3xl md:text-6xl lg:text-7xl font-display font-black text-white leading-[0.9] tracking-tighter">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00f2ff] to-[#7b2ff7] italic pr-2">
                          {t.visualText}
                        </span>
                      </h3>
                    </div>
                  ...
                  <div className="relative z-20 max-w-md mt-24 md:mt-20 lg:mt-0">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4 md:mt-6">
                      {activeCase.tags.map((tag, i) => (
                        <span
                          key={i}
                          className="px-2 py-1 md:px-3 md:py-1 bg-white/5 [.light_&]:bg-black/5 rounded-lg text-[10px] md:text-xs font-mono text-white/50 border border-white/5 [.light_&]:border-black/5"
                        >
                          #{tag}
                        </span>
                      ))}
              ...
              <div className="lg:col-span-4 rounded-[32px] md:rounded-[40px] border border-white/10 [.light_&]:border-black/5 bg-[#0a0c1a] [.light_&]:bg-white p-6 md:p-10 flex flex-col relative overflow-hidden">
                ...
                <div className="relative z-10 mb-4 md:mb-8">
                  <h4 className="text-xs md:text-sm font-bold uppercase tracking-[0.2em] text-white/40 mb-2">
                    {t.featuresTitle}
                  </h4>
                ...
                <div className="relative z-10 flex-1 space-y-4 md:space-y-8">
                  {activeCase.featuresList?.map((feature, i) => (
                    ...
                    >
                      <h5 className="text-sm md:text-lg font-bold text-white mb-1 md:mb-2">
                        {feature.title}
                      </h5>
                ...
                <div className="flex lg:hidden gap-4 mt-6 md:mt-8 pt-4 md:pt-6 border-t border-white/5 justify-end">
                  <button
                    onClick={handlePrev}
                    className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center active:bg-white/10"
                  >
                    <svg
                      width="20"
                      height="20"
