          ...
          >
            <div className="relative aspect-[4/5] rounded-[40px] overflow-hidden border border-white/10 shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-black/90 to-transparent">
                ...
                <p className="text-[#00f2ff] font-mono text-sm uppercase tracking-widest">
                  {data.role}
                </p>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {data.skills.map((skill, i) => (
                  <span
                    key={i}
                    className="px-4 py-2 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-xs font-mono text-[#00f2ff]"
                  >
                    {skill}
                  </span>
                ))}
