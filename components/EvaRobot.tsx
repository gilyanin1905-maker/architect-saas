...
import { ROBOT_DATA } from "../constants";
    ...
    <g transform={`translate(${eyeX}, ${eyeY})`}>
      <defs>
        ...
        <linearGradient id="eyeColor" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#80faff" />
      ...
      <g
        filter="url(#blueGlow)"
        fill={emotion === "angry" ? "url(#eyeColorRed)" : "url(#eyeColor)"}
      >
        {emotion === "idle" && (
          <>
            <motion.ellipse
        ...
        {emotion === "angry" && (
          <>
            <motion.ellipse cx="28" cy="24" rx="11" ry="4" transform="rotate(15 28 24)" />
            <motion.ellipse cx="56" cy="24" rx="11" ry="4" transform="rotate(-15 56 24)" />
          </>
        )}
        {emotion === "thinking" && (
          <>
            ...
            />
            <motion.ellipse cx="56" cy="22" rx="10" ry="8" transform="rotate(8 56 22)" />
          </>
        )}
        {emotion === "alert" && (
          <>
      ...
      <g opacity="0.3">
        <line x1="15" y1="20" x2="69" y2="20" stroke="black" strokeWidth="0.5" />
        <line x1="15" y1="22" x2="69" y2="22" stroke="black" strokeWidth="0.5" />
        <line x1="15" y1="24" x2="69" y2="24" stroke="black" strokeWidth="0.5" />
      </g>
    </g>
  );
};
    ...
    <div className="relative w-24 h-36 md:w-36 md:h-52 drop-shadow-2xl transition-all duration-300">
      <svg viewBox="0 0 100 150" className="w-full h-full overflow-visible">
        ...
        <motion.g
          initial={{ y: 0 }}
          animate={
            mode === "threat" ? { y: 5, rotate: 10, x: -5 } : { y: [0, 2, 0], rotate: [0, 2, 0] }
          }
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        >
          <path
            d="M20 55 C 10 55, 5 65, 8 85 C 10 110, 22 115, 28 110 C 26 95, 25 70, 25 55 Z"
            fill="url(#bodyGrad)"
        ...
        <motion.g
          ...
          animate={
            mode === "threat"
              ? { y: -20, x: 10, rotate: -90 }
              : { y: [0, 2, 0], x: 0, rotate: [0, -2, 0] }
          }
          transition={{ type: "spring", stiffness: 100, damping: 15 }}
        >
          <path
            d="M80 55 C 90 55, 95 65, 92 85 C 90 110, 78 115, 72 110 C 74 95, 75 70, 75 55 Z"
            fill="url(#bodyGrad)"
            filter="drop-shadow(-2px 4px 4px rgba(0,0,0,0.2))"
          />
        ...
        <motion.g animate={{ rotate: bodyRotate }} style={{ transformOrigin: "50% 80%" }}>
          <path
            d="M28 55 C 28 42, 72 42, 72 55 C 72 105, 62 138, 50 142 C 38 138, 28 105, 28 55 Z"
            fill="url(#bodyGrad)"
          ...
          <motion.circle
            ...
            cy="65"
            r="1.5"
            fill={mode === "threat" ? "#ff0000" : "#00f2ff"}
...
// --- New EvaRobot Component (from edit) ---
const EvaRobot: React.FC<EvaRobotProps> = ({
  isChatOpen,
  setIsChatOpen,
  isVisible,
  lang,
