...
const ContactForm: React.FC<ContactFormProps> = ({ lang }) => {
  ...
  const prevStatusRef = useRef<"idle" | "loading" | "success" | "error">("idle");
  ...
  // Focus management on status transitions
  useEffect(() => {
    if (status === "success") {
      // Focus success container when submission completes
      successContainerRef.current?.focus();
    } else if (status === "idle" && prevStatusRef.current === "success") {
      // Focus Name field only when resetting from success back to idle
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-10 md:gap-20">
          <div>
            ...
            <p className="text-white/60 mb-8 md:mb-12 text-base md:text-lg">{t.description}</p>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex gap-4 md:gap-6 items-center group">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-base md:text-lg font-bold hover:text-[#00f2ff] transition-colors"
                  >
                    @Architect_SaaS
                  </a>
                </div>
              ...
              <div className="flex gap-4 md:gap-6 items-center group">
                ...
                <div>
                  <div className="text-xs font-bold text-white/40 uppercase mb-1">
                    {t.telegramBot}
                  </div>
                  <a
                    href="https://t.me/Architect_AI_Bot"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-base md:text-lg font-bold hover:text-[#00f2ff] transition-colors"
                  >
              ...
              <div className="flex gap-4 md:gap-6 items-center group">
                ...
                <div>
                  ...
                  <a
                    href="https://vk.com/architect_saas"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-base md:text-lg font-bold hover:text-[#00f2ff] transition-colors"
                  >
              ...
              <div className="flex gap-4 md:gap-6 items-center group">
                ...
                <div>
                  ...
                  <a
                    href="mailto:contact@architect-saas.dev"
                    className="text-base md:text-lg font-bold hover:text-[#7b2ff7] transition-colors"
                  >
                    contact@architect-saas.dev
                  </a>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                  <div className="space-y-2">
                    <label htmlFor="contact-name" className="text-xs font-bold text-white/40 uppercase ml-1">
                      {t.name}
                    </label>
                    <input
                      ref={nameInputRef}
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-company" className="text-xs font-bold text-white/40 uppercase ml-1">
                      {t.company}
                    </label>
                    <input
                      id="contact-company"
                ...
                <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                  <div className="space-y-2">
                    <label htmlFor="contact-email" className="text-xs font-bold text-white/40 uppercase ml-1">
                      {t.email}
                    </label>
                    <input
                      id="contact-email"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-telegram" className="text-xs font-bold text-white/40 uppercase ml-1">
                      {t.telegram}
                    </label>
                    <input
                      id="contact-telegram"
                ...
                <div className="space-y-2">
                  <label htmlFor="contact-message" className="text-xs font-bold text-white/40 uppercase ml-1">
                    {t.message}
                  </label>
                  <textarea
                    id="contact-message"
