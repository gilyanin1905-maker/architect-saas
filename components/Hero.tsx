          ...
          >
            ...
            >
              <a
                ...
                className="flex items-center gap-3 px-6 py-3 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 transition-all group hover:scale-105 backdrop-blur-md"
              >
                <div className="w-5 h-5 text-[#00f2ff] group-hover:scale-110 transition-transform">
                  <BotIcon />
                </div>
              ...
              <a
                ...
                className="flex items-center gap-3 px-6 py-3 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 transition-all group hover:scale-105 backdrop-blur-md"
              >
                <div className="w-5 h-5 text-[#0077FF] group-hover:scale-110 transition-transform">
                  <VKIcon />
                </div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-white/60 group-hover:text-white">
                  VK Community
