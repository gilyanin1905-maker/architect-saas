            ...
            >
              <div className="glass rounded-2xl p-2 border border-white/10 bg-[#02040a]/90 backdrop-blur-xl shadow-2xl flex flex-col gap-1 overflow-hidden">
                ...
                {navLinks.map((link) => (
                  ...
                  >
                    <span className="text-xs font-bold uppercase tracking-widest text-white/80 group-hover:text-white">
                      {link.name}
                    </span>
            ...
            {isMobileMenuOpen && (
              ...
              >
                ...
                <a
                  ...
                  className="flex items-center justify-center w-10 h-10 bg-white rounded-full text-black shadow-lg"
                >
          ...
          <div className="hidden md:flex items-center gap-4 sm:gap-8 px-2 sm:px-6 sm:py-2">
            ...
            >
              ...
              <div className="hidden lg:flex flex-col">
                <span className="font-display font-bold text-xs tracking-widest uppercase text-white [.light_&]:text-slate-800">
                  Architect
                </span>
              </div>
            </a>
