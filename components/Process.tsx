...
const ArchitectureIcon = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Base Layer */}
    <motion.path
      d="M10 40L30 50L50 40L30 30L10 40Z"
    ...
    {/* Mid Layer */}
    <motion.path
      d="M10 30L30 40L50 30L30 20L10 30Z"
      stroke="var(--accent-cyan)"
      strokeWidth="2"
      fill="var(--accent-cyan)"
      fillOpacity="0.1"
    ...
    {/* Top Layer */}
    <motion.path
      d="M10 20L30 30L50 20L30 10L10 20Z"
      stroke="currentColor"
      strokeWidth="2"
      fill="currentColor"
      fillOpacity="0.1"
...
const BrainIcon = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Brain Hemispheres */}
    <path
      d="M28 15C18 15 12 22 12 32C12 42 20 48 28 48V15Z"
      stroke="var(--accent-cyan)"
      strokeWidth="1.5"
      fill="url(#brainGrad)"
    />
    <path
      d="M32 15C42 15 48 22 48 32C48 42 40 48 32 48V15Z"
      stroke="var(--accent-purple)"
      strokeWidth="1.5"
      fill="url(#brainGrad)"
    />
    ...
    >
      ...
      />
      <path
        d="M50 44V46M50 54V56M44 50H46M54 50H56"
        stroke="var(--accent-cyan)"
        strokeWidth="1.5"
      />
...
const IntegrationIcon = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Central Hexagon */}
    <path
      d="M30 22L37 26V34L30 38L23 34V26L30 22Z"
      stroke="currentColor"
      strokeWidth="2"
      fill="currentColor"
      fillOpacity="0.1"
    ...
    {[
      ...
      <motion.circle
        ...
        animate={{
          scale: [1, 1.5, 1],
          fill: ["var(--accent-purple)", "var(--accent-cyan)", "var(--accent-purple)"],
        }}
...
const SupportIcon = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Shield Container */}
    <path
      d="M30 55L12 45V18L30 8L48 18V45L30 55Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeOpacity="0.2"
      fill="currentColor"
      ...
      <div className="container mx-auto px-6 mt-0">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-4 md:space-y-8 order-1 lg:order-2">
            ...
            >
              <div
                className="text-[8px] md:text-[10px] font-mono font-bold uppercase tracking-[0.5em] mb-2 md:mb-4"
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 mt-4 md:mt-8 justify-center lg:justify-start">
                {t.tags.map((tag, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 md:px-4 md:py-1.5 rounded-full border border-white/5 bg-white/[0.02] text-[9px] md:text-[10px] uppercase tracking-widest text-white/30"
                  >
                    {tag}
                  </span>
                ))}
      ...
      >
        ...
        >
          {[...techBrands, ...techBrands, ...techBrands].map((brand, i) => (
            <span
              key={i}
              className="text-xs md:text-sm font-mono font-bold text-white/50 uppercase tracking-widest flex items-center gap-2"
            >
              <span
